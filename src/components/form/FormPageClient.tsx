...
export default function FormPageClient({ totalSteps, webhookUrl }: FormPageClientProps) {
  ...
  const onSubmit = async (values: FormValues) => {
    ...
    const payload = {
      ...values,
      ...utms,
      funil: undefined, // funilId deve vir do server via templateConfig, se necessário
