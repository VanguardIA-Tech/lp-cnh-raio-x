    ...
    <section className="bg-slate-950 py-16 sm:py-24">
      <div className={sectionContainerClass}>
        ...
        <div className="mt-12 flex justify-center sm:mt-16">
          <Button
            asChild
            className="h-18 rounded-md bg-blue-600 px-9 text-2xl font-semibold text-white shadow-lg transition-all duration-300 hover:bg-blue-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950 active:scale-[0.98]"
          >
            <Link
              href="/form"
              id="cta-pain-points"
